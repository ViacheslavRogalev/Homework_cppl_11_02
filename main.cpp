...
int main(int argc, char** argv) 
{
	...
	try
	{
		auto number1 = big_integer("578467356498605987453236274573216456372819974536625536647580192873465788499377266377873774667278812");
		auto number2 = big_integer("345643269487");
